...
class Widget(QWidget):
    ...
    #The hard way to setup QMessageBox
    def button_clicked_hard(self):
        ...
        ret = message.exec() # you need the .exec() to get the message box to show up
        if ret == QMessageBox.Ok :
            print("User chose Ok")
        else :
            print("User chose Cancel")

    # The easy ways.  Same result, but way less lines
    ...
    def button_clicked_warning(self):
        ret = QMessageBox.warning(self, "Message Title", "This is a warning", QMessageBox.Ok | QMessageBox.Cancel)
        if ret == QMessageBox.Ok :
            print("User chose Ok")
        else :
            print("User chose Cancel")         
    ...
    def button_clicked_about(self):
        ret = QMessageBox.about(self, "Message Title", "This is about me")
        if ret == QMessageBox.Ok :
            print("User chose Ok")
        else :
            print("User chose Cancel") 